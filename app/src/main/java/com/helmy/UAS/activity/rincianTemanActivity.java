...
import com.helmy.UAS.presenter.rincianTemanPresenter;
...
public class rincianTemanActivity extends AppCompatActivity implements rincianTemanView, View.OnClickListener {

    Toolbar toolbar;
    ImageView imgAva;
    TextView tvName, tvNIM, tvClass, tvPhone, tvEmail, tvIg;
    rincianTemanPresenter presenter;
    Friends friends;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rincian_teman);
        initView();
        setSupportActionBar(toolbar);
        Objects.requireNonNull(getSupportActionBar()).setDisplayHomeAsUpEnabled(true);

        presenter = new rincianTemanPresenter(this, this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.nav_delete:
                ...
                break;
            case R.id.nav_edit:
                Intent i = new Intent(rincianTemanActivity.this, modifikasiTemanActivity.class);
                i.putExtra("type", 1);
