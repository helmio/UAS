...
import com.helmy.UAS.presenter.modifikasiTemanPresenter;
...
public class modifikasiTemanActivity extends AppCompatActivity implements modifikasiTemanView {

    Toolbar toolbar;
    TextView tvTitle;
    EditText etName, etNIM, etClass, etPhone, etEmail, etIG;
    modifikasiTemanPresenter presenter;
    int type;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modifikasi_teman);
        initView();
        ...
        presenter = new modifikasiTemanPresenter(this, this);
