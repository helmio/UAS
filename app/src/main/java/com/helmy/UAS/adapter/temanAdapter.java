...
import com.helmy.UAS.activity.rincianTemanActivity;
...
public class temanAdapter extends RecyclerView.Adapter<temanAdapter.ViewHolder>  {
    ...
    public temanAdapter(ArrayList<Friends> friends, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int i) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(v.getContext(), rincianTemanActivity.class);
